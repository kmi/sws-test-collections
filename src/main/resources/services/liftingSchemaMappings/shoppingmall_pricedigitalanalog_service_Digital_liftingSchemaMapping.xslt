...
<xsl:value-of select="service:Digital/service:hasDimension/service:breadth"/>
</n1:breadth>
<n1:length rdf:datatype="http://www.w3.org/2001/XMLSchema#float">
<xsl:value-of select="service:Digital/service:hasDimension/service:length"/>
</n1:length>
<n1:height rdf:datatype="http://www.w3.org/2001/XMLSchema#float">
<xsl:value-of select="service:Digital/service:hasDimension/service:height"/>
</n1:height>
<n1:units rdf:datatype="http://www.w3.org/2001/XMLSchema#string">
<xsl:value-of select="service:Digital/service:hasDimension/service:units"/>
</n1:units>
</n1:Dimension>
</n1:hasDimension>
<n1:hasBody>
...
<xsl:value-of select="service:Digital/service:hasBody/service:shutter-speed/service:steps"/>
</n1:steps>
<n1:min rdf:datatype="http://www.w3.org/2001/XMLSchema#float">
<xsl:value-of select="service:Digital/service:hasBody/service:shutter-speed/service:min"/>
</n1:min>
<n1:max rdf:datatype="http://www.w3.org/2001/XMLSchema#float">
<xsl:value-of select="service:Digital/service:hasBody/service:shutter-speed/service:max"/>
</n1:max>
<n1:units rdf:datatype="http://www.w3.org/2001/XMLSchema#string">
<xsl:value-of select="service:Digital/service:hasBody/service:shutter-speed/service:units"/>
</n1:units>
</n1:Range>
</n1:shutter-speed>
</n1:Body>
...
<xsl:value-of select="service:Digital/service:hasLens/service:f-stop"/>
</n1:f-stop>
<n1:focal-length rdf:datatype="http://www.w3.org/2001/XMLSchema#string">
<xsl:value-of select="service:Digital/service:hasLens/service:focal-length"/>
</n1:focal-length>
<n1:aperture rdf:datatype="http://www.w3.org/2001/XMLSchema#string">
<xsl:value-of select="service:Digital/service:hasLens/service:aperture"/>
</n1:aperture>
<n1:size rdf:datatype="http://www.w3.org/2001/XMLSchema#string">
<xsl:value-of select="service:Digital/service:hasLens/service:size"/>
</n1:size>
<n1:isCompatibleWith>
<n1:Body>
<n1:shutter-speed>
